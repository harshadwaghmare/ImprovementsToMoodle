 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
abstract class qtype_simple_multichoice_renderer_base extends qtype_with_combined_feedback_renderer {
     ...
     * options returned by {@link qtype_simple_multichoice:;get_numbering_styles()}.
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_simple_multichoice_single_renderer extends qtype_simple_multichoice_renderer_base {
    ...
    protected function prompt() {
        return get_string('selectone', 'qtype_simple_multichoice');
    }
    ...
    public function correct_response(question_attempt $qa) {
        ...
        foreach ($question->answers as $ansid => $ans) {
            if (question_state::graded_state_for_fraction($ans->fraction) ==
                ...
                return get_string('correctansweris', 'qtype_simple_multichoice',
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_simple_multichoice_multi_renderer extends qtype_simple_multichoice_renderer_base {
    protected function get_input_type() {
        return 'checkbox';
    }
    ...
    protected function prompt() {
        return get_string('selectmulti', 'qtype_simple_multichoice');
    }
    ...
    protected function num_parts_correct(question_attempt $qa) {
        if ($qa->get_question()->get_num_selected_choices($qa->get_last_qt_data()) >
            ...
            return get_string('toomanyselected', 'qtype_simple_multichoice');
        }
