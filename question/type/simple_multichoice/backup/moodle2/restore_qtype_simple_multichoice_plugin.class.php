 ...
 * needed to restore one simple_multichoice qtype plugin
 *
 * @copyright  2010 onwards Eloy Lafuente (stronk7) {@link http://stronk7.com}
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class restore_qtype_simple_multichoice_plugin extends restore_qtype_plugin {
    ...
    protected function define_question_plugin_structure() {
        ...
        // Add own qtype stuff.
        $elename = 'simple_multichoice';
        // We used get_recommended_name() so this works.
        $elepath = $this->get_pathfor('/simple_multichoice');
    ...
    /**
     * Process the qtype/simple_multichoice element
     */
    public function process_simple_multichoice($data) {
        global $DB;
        ...
        // question_simple_multichoice too.
        if ($questioncreated) {
            // Adjust some columns.
            ...
            // Insert record.
            $newitemid = $DB->insert_record('question_simple_multichoice', $data);
            // Create mapping (needed for decoding links).
            $this->set_mapping('question_simple_multichoice', $oldid, $newitemid);
        }
    }
     ...
     * recoded pointing to all the restored stuff for simple_multichoice questions
     *
    ...
    public static function define_decode_contents() {
        ...
        $fields = array();
        $contents[] = new restore_decode_content('question_simple_multichoice',
                $fields, 'question_simple_multichoice');
