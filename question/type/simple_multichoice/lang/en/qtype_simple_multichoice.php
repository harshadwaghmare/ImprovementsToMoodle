...
$string['pluginname'] = 'Simple Multiple choice';
...
$string['pluginname_link'] = 'question/type/simple_multichoice';
$string['pluginnameadding'] = 'Adding a Simple Multiple choice question';
$string['pluginnameediting'] = 'Editing a Simple Multiple choice question';
$string['pluginnamesummary'] = 'Allows the selection of a single response from given options(single answer only).';
