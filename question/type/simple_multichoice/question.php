 ...
 * @copyright  2009 The Open University (see README.txt)
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
abstract class qtype_simple_multichoice_base extends question_graded_automatically {
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_simple_multichoice_single_question extends qtype_simple_multichoice_base {
    public function get_renderer(moodle_page $page) {
        return $page->get_renderer('qtype_simple_multichoice', 'single');
    }
    ...
    public function get_validation_error(array $response) {
        ...
        return get_string('pleaseselectananswer', 'qtype_simple_multichoice');
    }
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_simple_multichoice_multi_question extends qtype_simple_multichoice_base {
    public function get_renderer(moodle_page $page) {
        return $page->get_renderer('qtype_simple_multichoice', 'multi');
    }
    ...
    public function get_validation_error(array $response) {
        ...
        return get_string('pleaseselectatleastoneanswer', 'qtype_simple_multichoice');
    }
