...
// Grade report
if($gid == $USER->id){
  $grade_report = "<a href=\"{$CFG->wwwroot}/user/profile/grade_report.php\"</a>". get_string('grade_report');
  echo html_writer::tag('dt', get_string('grade_report'));
  echo html_writer::tag('dd', $grade_report);
}
